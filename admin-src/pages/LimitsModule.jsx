...
const SECTIONS = [
  {
    ...
    fields: [
      { key: 'dailyFreeLessons', label: 'Күнүнө акысыз сабак саны', min: 1, help: 'Ушул сандан ашык сабак өткөндөн кийин студент "Жаңы энергия эртеге чыгат" экранын көрөт.' },
      { key: 'maxBonusEnergyPerDay', label: 'Монетага сатылып алынуучу кошумча энергиянын күндүк чеги', min: 0, help: '"Дүкөн" бөлүмүндөгү энергия толтуруучу товар күнүнө канча жолу сатылып алынышы мүмкүн.' },
    ],
  },
  {
